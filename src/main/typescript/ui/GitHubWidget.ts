...
export class GitHubWidget extends BoxLayout {
    ...
    public static readonly metaInfo: MetaInfo = {
        ...
        Properties: {
            ...
            textVisible: ParamSpec.boolean('text-visible', 'Text Visible', 'The visibility of the text on the widget', ParamFlags.READWRITE, true),
        }
    };
    ...
    public constructor(defaultIcon: GioIcon, initialText = '') {
        super({
